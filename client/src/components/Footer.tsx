const Footer = (props:{hideButton?:boolean})=>{
    const {hideButton} = props;
    return(
        <div className="mt-20 grid text-xl sm:text-2xl"> 
            <button className="mx-auto border text-white bg-blue-800 p-3 rounded-xl cursor-pointer" hidden={hideButton}>Explore a Customized Strategy</button>
